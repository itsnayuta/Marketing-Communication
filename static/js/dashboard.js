(() => {
  ...
  const line = (id, labels, values, label, color) => new Chart(document.getElementById(id), {
    type: "line", data: { labels, datasets: [{ label, data: values, borderColor: color, backgroundColor: `${color}18`, fill: true, tension: .35, pointRadius: 2 }] },
  ...
  const bars = (id, labels, values, color) => new Chart(document.getElementById(id), {
